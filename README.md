...
| Layer | Description | Records | Included in Repo? |
|---|---|---|---|
| **Bronze** | Raw, unmodified ingested data | 16,281,039 | No (3.6 GB — see Kaggle) |
| **Silver** | Cleaned, deduplicated, type-cast, partitioned by year (Delta) | 9,508,621 | No (≈1.5 GB — generated by notebook) |
| **Gold** | Curated analytical aggregate tables | ~Hundreds | **Yes** (`data/gold/`) |
